                        ...
                        <div className="w-[600px] flex flex-wrap gap-4 justify-between pb-6">
                            {
                                item.memory.map(item => (
                                    <div className="flex items-center justify-between w-[35%]">
                                        ...
                                        <h1 onClick={() => console.log(item.price >= 1000 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19)} className="font-bold bg-green-700 rounded p-1 text-white flex">{((item.price >= 1000 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs).toLocaleString() + "UZS"}</h1>
                                    </div>
                                ))
                            }
                        </div>
                            ...
                            <div className="bg-yellow-400 p-1 text-white rounded-md">
                                {
                                    item.memory.map(item => (
                                        <>
                                            <h1 className="font-bold">Предоплата: {(((item.price >= 1000 ? item.price + 70 : item.price >= 900 ? item.price + 60 : item.price >= 700 ? item.price + 50 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20).toLocaleString() + "UZS"}</h1>
                                            <div className="flex items-center justify-between gap-2 p-1 font-bold">
                                                {item.name}
                                                <h1 className="font-bold flex flex-col items-center">3-ой {Math.round((((item.price >= 1000 ? item.price + 70 : item.price >= 900 ? item.price + 60 : item.price >=  700 ? item.price + 50 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20) + (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20)) / 100 * 20.104) / 3).toLocaleString() + "UZS"} </h1>
                                                <h1 className="font-bold">6-ой {Math.round((((item.price >= 1000 ? item.price + 70 : item.price >= 900 ? item.price + 60 : item.price >=  700 ? item.price + 50 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20) + (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20)) / 100 * 36.757) / 6).toLocaleString() + "UZS"} </h1>
                                                <h1 className="font-bold">12-ой {Math.round((((item.price >= 1000 ? item.price + 70 : item.price >= 900 ? item.price + 60 : item.price >=  700 ? item.price + 50 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20) + (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) - (((item.price >= 1100 ? item.price + 60 : item.price >= 900 ? item.price + 50 : item.price >=  700 ? item.price + 40 : item.price >= 500 ? item.price + 30 : item.price + 19) * curs) / 100 * 20)) / 100 * 74) / 12).toLocaleString() + "UZS"} </h1>
                                            </div>
                                        </>
                                    ))
                                }
